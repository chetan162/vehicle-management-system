<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Accord.aspx.cs" Inherits="WebApplication1.Accord" %>
       ...
       <div style="height: 186px; box-shadow: rgb(136, 136, 136) 0px 0px 15px 1px; position :absolute; top: -76px; left: -11px; width: 190px;" >  
        <asp:Image ID="Image2" runat="server" Height="190px" 
               ...
               ImageUrl="~/images/Untitled.png" />
                 ...
                 <br />
                 <br />
                 <img alt="" class="style1" src="PARTS/speci/accord.jpg" />
                 <div align="center" 
                     style="height: 540px; position:absolute; left: 35px; width: 1788px; top:11767px;">  
      <br />
      <br />
      <br />
      <br />
