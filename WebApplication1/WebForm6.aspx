       ...
       <div style="height: 186px; box-shadow: rgb(136, 136, 136) 0px 0px 15px 1px; position :absolute; top: -76px; left: -11px; width: 190px;" >  
        <asp:Image ID="Image2" runat="server" Height="190px" 
               ...
               ImageUrl="~/images/Untitled.png" />
                 ...
                 <br />
                 <br />
                   <img alt="" class="style1" src="PARTS/front/Brio.jpg" />
                   <br />
                 <br />
                   <img alt="" class="style2" src="PARTS/front/amaze.jpg" />
              <div style =" position :absolute; top: 754px; left: 891px;"><img alt="" class="style2" 
                     src="PARTS/front/Honda-Amaze-Left-Front-Three-Quarter-99803.jpg" /></div>
                     <br />
                 <br />
                 <img alt="" class="style3" src="PARTS/front/accord.jpg" />
                 <br />
                 <br />
                 <img alt="" 
                     class="style9" src="PARTS/front/City.jpg" />
                 <br />
                 <br />
                <img alt="" class="style10" src="PARTS/front/Honda-Jazz.jpg" />

</div>
<div style=" position :absolute; top: 642px; left: 293px; width: 494px; height: 103px;">
<asp:Button ID="Button13" runat="server" BackColor="Transparent" 
        Font-Bold="False" Font-Names="Forte" Font-Size="55px" ForeColor="#FFCCFF" 
        Height="90px" Text="READ MORE" Width="395px" onclick="Button13_Click" />
</div>
<div style=" position :absolute; top: 951px; left: 927px; width: 426px; height: 103px;">


    <asp:Button ID="Button14" runat="server" BackColor="Transparent" 
        Font-Bold="False" Font-Names="Forte" Font-Size="55px" ForeColor="#666666" 
        Height="90px" Text="READ MORE" Width="395px" onclick="Button14_Click1" />
</div>
<div style=" position :absolute; top: 1619px; left: 110px; width: 426px; height: 103px;">


    <asp:Button ID="Button15" runat="server" BackColor="Transparent" 
        Font-Bold="False" Font-Names="Forte" Font-Size="55px" ForeColor="#FFCCFF" 
        Height="90px" Width="395px" onclick="Button15_Click1" />


</div>
<div style=" position :absolute; top: 2303px; left: 1372px; width: 426px; height: 103px;">


    <asp:Button ID="Button16" runat="server" BackColor="Transparent" 
        Font-Bold="False" Font-Names="Forte" Font-Size="55px" ForeColor="Gray" 
        Height="90px" Text="READ MORE" Width="395px" onclick="Button16_Click1" />
</div>
<div style=" position :absolute; top: 4120px; left: 1201px; width: 426px; height: 103px;">


    <asp:Button ID="Button17" runat="server" BackColor="Transparent" 
        Font-Bold="False" Font-Names="Forte" Font-Size="55px" ForeColor="#333300" 
        Height="90px" Text="READ MORE" Width="395px" />
<div>
<div style=" position :absolute; top: 437px; left: -1092px; width: 426px; height: 103px;">


    <asp:Button ID="Button18" runat="server" BackColor="Transparent" 
        Font-Bold="False" Font-Names="Forte" Font-Size="55px" ForeColor="#990000" 
        Height="90px" Text="READ MORE" Width="395px" />
</div>
<div align="center" 
        
         
        style="height: 540px; position:absolute; left: -1156px; width: 1788px; top: 1267px;">  
      <br />
      <br />
      <br />
      <br />
